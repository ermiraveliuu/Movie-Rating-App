...
export class MoviePageComponent implements OnInit {
  ...
  getLanguage(language: string): string {
    return this.languages.find(l => l.iso_639_1 === language)?.name ?? 'Not Known'
  }
  json = {
    results: [
      {
  ...
  ngOnInit() {
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMjQ3MmVjYTMzYmUwMGY4MTIxNTIwZTJjMGYxZWMzNiIsInN1YiI6IjY1Yzc5NzUzYTMxNDQwMDE4NjhkZTBhMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.VJwTY7gIeaTAKd5vOUdtbfNBjTE2elNIjVbkLbbMM5s'
      }
    };
    const movies: any = [];
